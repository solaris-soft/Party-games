...
{#if showContent}
	...
	>
		...
		<div
			class="absolute bottom-0 right-0 w-16 h-16 border-b-2 border-r-2 border-green-500/30"
		></div>
		...
		<div class="text-center mb-8 relative">
			<div
				class="absolute inset-0 bg-gradient-to-r from-transparent via-green-500/5 to-transparent animate-shimmer"
			></div>
			<p
				class="text-green-400/70 text-lg font-['Rusty+Attack'] italic riddler-text relative z-10"
				transition:fade
			>
				{riddleText}
			</p>
		...
		>
			<div class="relative">
				<div
					class="absolute -inset-0.5 bg-gradient-to-r from-green-500/50 to-green-700/50 rounded-lg blur opacity-30"
				></div>
				<input
					type="text"
			...
			>
				<div
					class="absolute inset-0 bg-gradient-to-r from-transparent via-green-500/20 to-transparent animate-shimmer"
				></div>
